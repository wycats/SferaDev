...
export const operationsByPath = {
	...
	"GET /accounts/{account_id}/abuse-reports/{report_id}/mitigations": listMitigations,
	"POST /accounts/{account_id}/abuse-reports/{report_id}/mitigations/appeal": requestReview,
	...
	"GET /accounts/{account_id}/access/ai-controls/mcp/portals": mcpPortalsApiListPortals,
	"POST /accounts/{account_id}/access/ai-controls/mcp/portals": mcpPortalsApiCreatePortals,
	"DELETE /accounts/{account_id}/access/ai-controls/mcp/portals/{id}": mcpPortalsApiDeletePortals,
	"GET /accounts/{account_id}/access/ai-controls/mcp/portals/{id}": mcpPortalsApiFetchGateways,
	"PUT /accounts/{account_id}/access/ai-controls/mcp/portals/{id}": mcpPortalsApiUpdatePortals,
	"GET /accounts/{account_id}/access/ai-controls/mcp/servers": mcpPortalsApiListServers,
	"POST /accounts/{account_id}/access/ai-controls/mcp/servers": mcpPortalsApiCreateServers,
	"DELETE /accounts/{account_id}/access/ai-controls/mcp/servers/{id}": mcpPortalsApiDeleteServers,
	"GET /accounts/{account_id}/access/ai-controls/mcp/servers/{id}": mcpPortalsApiFetchServers,
	"PUT /accounts/{account_id}/access/ai-controls/mcp/servers/{id}": mcpPortalsApiUpdateServers,
	"POST /accounts/{account_id}/access/ai-controls/mcp/servers/{id}/sync": mcpPortalsApiSyncServer,
	...
	"DELETE /accounts/{account_id}/ai-search/instances/{id}": aiSearchDeleteInstances,
	...
	"POST /accounts/{account_id}/ai/run/@cf/baai/omni-bge-large-en-v1.5":
		workersAiPostRunCfBaaiOmniBgeLargeEnV15,
	"POST /accounts/{account_id}/ai/run/@cf/baai/omni-bge-m3": workersAiPostRunCfBaaiOmniBgeM3,
	...
	"GET /accounts/{account_id}/ai/run/@cf/deepgram/aura-1": workersAiPostWebsocketRunCfDeepgramAura1,
	"POST /accounts/{account_id}/ai/run/@cf/deepgram/aura-1": workersAiPostRunCfDeepgramAura1,
	"GET /accounts/{account_id}/ai/run/@cf/deepgram/aura-1-internal":
		workersAiPostWebsocketRunCfDeepgramAura1Internal,
	"GET /accounts/{account_id}/ai/run/@cf/deepgram/aura-2": workersAiPostWebsocketRunCfDeepgramAura2,
	"GET /accounts/{account_id}/ai/run/@cf/deepgram/aura-2-en":
		workersAiPostWebsocketRunCfDeepgramAura2En,
	"POST /accounts/{account_id}/ai/run/@cf/deepgram/aura-2-en": workersAiPostRunCfDeepgramAura2En,
	"GET /accounts/{account_id}/ai/run/@cf/deepgram/aura-2-es":
		workersAiPostWebsocketRunCfDeepgramAura2Es,
	"POST /accounts/{account_id}/ai/run/@cf/deepgram/aura-2-es": workersAiPostRunCfDeepgramAura2Es,
	"GET /accounts/{account_id}/ai/run/@cf/deepgram/flux": workersAiPostWebsocketRunCfDeepgramFlux,
	"POST /accounts/{account_id}/ai/run/@cf/deepgram/flux": workersAiPostRunCfDeepgramFlux,
	"GET /accounts/{account_id}/ai/run/@cf/deepgram/nova-3": workersAiPostWebsocketRunCfDeepgramNova3,
	"POST /accounts/{account_id}/ai/run/@cf/deepgram/nova-3": workersAiPostRunCfDeepgramNova3,
	...
	"POST /accounts/{account_id}/ai/run/@cf/openai/gpt-oss-120b": workersAiPostRunCfOpenaiGptOss120b,
	"POST /accounts/{account_id}/ai/run/@cf/openai/gpt-oss-20b": workersAiPostRunCfOpenaiGptOss20b,
	...
	"GET /accounts/{account_id}/ai/tomarkdown/supported": workersAiGetToMarkdownSupported,
	...
	"PUT /accounts/{account_id}/alerting/v3/policies/{policy_id}":
		notificationPoliciesUpdateANotificationPolicy,
	"GET /accounts/{account_id}/alerting/v3/silences": notificationSilencesListSilences,
	"POST /accounts/{account_id}/alerting/v3/silences": notificationSilencesCreateSilences,
	"PUT /accounts/{account_id}/alerting/v3/silences": notificationSilencesUpdateSilences,
	"DELETE /accounts/{account_id}/alerting/v3/silences/{silence_id}":
		notificationSilencesDeleteSilences,
	"GET /accounts/{account_id}/alerting/v3/silences/{silence_id}": notificationSilencesGetSilence,
	"GET /accounts/{account_id}/audit_logs": auditLogsGetAccountAuditLogs,
	"POST /accounts/{account_id}/autorag/rags/{id}/ai-search": autoragConfigAiSearch,
	...
	"GET /accounts/{account_id}/autorag/rags/{id}/jobs/{job_id}": autoragConfigGetJob,
	"GET /accounts/{account_id}/autorag/rags/{id}/jobs/{job_id}/logs": autoragConfigListJobLogs,
	...
	"GET /accounts/{account_id}/brand-protection/alerts": getAccountsAccountIdBrandProtectionAlerts,
	...
	"DELETE /accounts/{account_id}/brand-protection/brands":
		deleteAccountsAccountIdBrandProtectionBrands,
	"GET /accounts/{account_id}/brand-protection/brands": getAccountsAccountIdBrandProtectionBrands,
	"POST /accounts/{account_id}/brand-protection/brands": postAccountsAccountIdBrandProtectionBrands,
	...
	"POST /accounts/{account_id}/brand-protection/brands/patterns":
		postAccountsAccountIdBrandProtectionBrandsPatterns,
	"PATCH /accounts/{account_id}/brand-protection/clear": patchAccountsAccountIdBrandProtectionClear,
	...
	"GET /accounts/{account_id}/brand-protection/logo-matches/download":
		getAccountsAccountIdBrandProtectionLogoMatchesDownload,
	"GET /accounts/{account_id}/brand-protection/logos": getAccountsAccountIdBrandProtectionLogos,
	"POST /accounts/{account_id}/brand-protection/logos": postAccountsAccountIdBrandProtectionLogos,
	"DELETE /accounts/{account_id}/brand-protection/logos/{logo_id}":
		deleteAccountsAccountIdBrandProtectionLogosLogoId,
	"GET /accounts/{account_id}/brand-protection/logos/{logo_id}":
		getAccountsAccountIdBrandProtectionLogosLogoId,
	"GET /accounts/{account_id}/brand-protection/matches": getAccountsAccountIdBrandProtectionMatches,
	"GET /accounts/{account_id}/brand-protection/matches/download":
		getAccountsAccountIdBrandProtectionMatchesDownload,
	"DELETE /accounts/{account_id}/brand-protection/queries":
		deleteAccountsAccountIdBrandProtectionQueries,
	"GET /accounts/{account_id}/brand-protection/queries": getAccountsAccountIdBrandProtectionQueries,
	...
	"POST /accounts/{account_id}/brand-protection/scan-page":
		postAccountsAccountIdBrandProtectionScanPage,
	"POST /accounts/{account_id}/brand-protection/search": postAccountsAccountIdBrandProtectionSearch,
	"GET /accounts/{account_id}/brand-protection/submission-info":
		getAccountsAccountIdBrandProtectionSubmissionInfo,
	"POST /accounts/{account_id}/brand-protection/submit": postAccountsAccountIdBrandProtectionSubmit,
	...
	"POST /accounts/{account_id}/browser-rendering/screenshot": brapiPostScreenshot,
	...
	"PUT /accounts/{account_id}/builds/builds/{build_uuid}/cancel": cancelBuildByUuid,
	...
	"DELETE /accounts/{account_id}/builds/tokens/{build_token_uuid}": deleteBuildToken,
	...
	"POST /accounts/{account_id}/builds/triggers/{trigger_uuid}/builds": createManualBuild,
	...
	"DELETE /accounts/{account_id}/builds/triggers/{trigger_uuid}/environment_variables/{environment_variable_key}":
		deleteEnvironmentVariable,
	"POST /accounts/{account_id}/builds/triggers/{trigger_uuid}/purge_build_cache": purgeBuildCache,
	"GET /accounts/{account_id}/builds/workers/{external_script_id}/builds": listBuildsByScript,
	"GET /accounts/{account_id}/builds/workers/{external_script_id}/triggers": listTriggersByScript,
	...
	"GET /accounts/{account_id}/cloudforce-one/events/aggregate": getEventAggregate,
	"GET /accounts/{account_id}/cloudforce-one/events/attackers": getAttackerList,
	"GET /accounts/{account_id}/cloudforce-one/events/categories": getCategoryList,
	"GET /accounts/{account_id}/cloudforce-one/events/categories/catalog": getCategoryListComplete,
	"POST /accounts/{account_id}/cloudforce-one/events/categories/create": postCategoryCreate,
	"DELETE /accounts/{account_id}/cloudforce-one/events/categories/{category_id}":
		deleteCategoryDelete,
	"GET /accounts/{account_id}/cloudforce-one/events/categories/{category_id}": getCategoryRead,
	"PATCH /accounts/{account_id}/cloudforce-one/events/categories/{category_id}":
		patchCategoryUpdate,
	"POST /accounts/{account_id}/cloudforce-one/events/categories/{category_id}": postCategoryUpdate,
	...
	"POST /accounts/{account_id}/cloudforce-one/events/create/bulk": postEventCreateBulk,
	...
	"POST /accounts/{account_id}/cloudforce-one/events/dataset/create": postDatasetCreate,
	"DELETE /accounts/{account_id}/cloudforce-one/events/dataset/{dataset_id}": deleteDatasetDelete,
	"GET /accounts/{account_id}/cloudforce-one/events/dataset/{dataset_id}": getDatasetRead,
	"PATCH /accounts/{account_id}/cloudforce-one/events/dataset/{dataset_id}": patchDatasetUpdate,
	"POST /accounts/{account_id}/cloudforce-one/events/dataset/{dataset_id}": postDatasetUpdate,
	...
	"GET /accounts/{account_id}/cloudforce-one/events/dataset/{dataset_id}/targetIndustries":
		getTargetIndustryListByDataset,
	"POST /accounts/{account_id}/cloudforce-one/events/datasets/populate": postDatasetPopulate,
	"DELETE /accounts/{account_id}/cloudforce-one/events/event_tag/{event_id}": deleteEventTagDelete,
	...
	"GET /accounts/{account_id}/cloudforce-one/events/tags/categories": getTagCategoryList,
	"POST /accounts/{account_id}/cloudforce-one/events/tags/categories/create": postTagCategoryCreate,
	...
	"PATCH /accounts/{account_id}/cloudforce-one/events/tags/categories/{category_uuid}":
		patchTagCategoryUpdate,
	"POST /accounts/{account_id}/cloudforce-one/events/tags/create": postTagCreate,
	"DELETE /accounts/{account_id}/cloudforce-one/events/tags/{tag_uuid}": deleteTagDelete,
	"PATCH /accounts/{account_id}/cloudforce-one/events/tags/{tag_uuid}": patchTagUpdate,
	"GET /accounts/{account_id}/cloudforce-one/events/targetIndustries": getTargetIndustryList,
	...
	"POST /accounts/{account_id}/cloudforce-one/events/{event_id}": postEventUpdate,
	"GET /accounts/{account_id}/cloudforce-one/events/{event_id}/raw/{raw_id}": getEventRawRead,
	"PATCH /accounts/{account_id}/cloudforce-one/events/{event_id}/raw/{raw_id}": patchEventRawUpdate,
	"POST /accounts/{account_id}/cloudforce-one/events/{event_id}/raw/{raw_id}": postEventRawUpdate,
	"GET /accounts/{account_id}/cloudforce-one/events/{event_id}/relationships":
		getEventRelationships,
	"POST /accounts/{account_id}/cloudforce-one/requests": cloudforceOneRequestList,
	"GET /accounts/{account_id}/cloudforce-one/requests/constants": cloudforceOneRequestConstants,
	"POST /accounts/{account_id}/cloudforce-one/requests/new": cloudforceOneRequestNew,
	"POST /accounts/{account_id}/cloudforce-one/requests/priority": cloudforceOnePriorityList,
	"POST /accounts/{account_id}/cloudforce-one/requests/priority/new": cloudforceOnePriorityNew,
	"GET /accounts/{account_id}/cloudforce-one/requests/priority/quota": cloudforceOnePriorityQuota,
	...
	"PUT /accounts/{account_id}/cloudforce-one/requests/priority/{priority_id}":
		cloudforceOnePriorityUpdate,
	"GET /accounts/{account_id}/cloudforce-one/requests/quota": cloudforceOneRequestQuota,
	"GET /accounts/{account_id}/cloudforce-one/requests/types": cloudforceOneRequestTypes,
	"DELETE /accounts/{account_id}/cloudforce-one/requests/{request_id}": cloudforceOneRequestDelete,
	"GET /accounts/{account_id}/cloudforce-one/requests/{request_id}": cloudforceOneRequestGet,
	"PUT /accounts/{account_id}/cloudforce-one/requests/{request_id}": cloudforceOneRequestUpdate,
	...
	"DELETE /accounts/{account_id}/cloudforce-one/scans/config/{config_id}": deleteDeleteScans,
	"PATCH /accounts/{account_id}/cloudforce-one/scans/config/{config_id}": postConfigUpdate,
	"GET /accounts/{account_id}/cloudforce-one/scans/results/{config_id}": getGetOpenPorts,
	"POST /accounts/{account_id}/cloudforce-one/v2/events/graphql": postEventGraphQL,
	...
	"GET /accounts/{account_id}/connectivity/directory/services": connectivityServicesList,
	"POST /accounts/{account_id}/connectivity/directory/services": connectivityServicesPost,
	...
	"PATCH /accounts/{account_id}/d1/database/{database_id}": cloudflareD1UpdatePartialDatabase,
	"PUT /accounts/{account_id}/d1/database/{database_id}": cloudflareD1UpdateDatabase,
	...
	"DELETE /accounts/{account_id}/devices/physical-devices/{device_id}": deleteDevice,
	"GET /accounts/{account_id}/devices/physical-devices/{device_id}": getDevice,
	"POST /accounts/{account_id}/devices/physical-devices/{device_id}/revoke": revokeDevice,
	...
	"POST /accounts/{account_id}/devices/registrations/revoke": revokeRegistrations,
	"POST /accounts/{account_id}/devices/registrations/unrevoke": unrevokeRegistrations,
	"DELETE /accounts/{account_id}/devices/registrations/{registration_id}": deleteRegistration,
	"GET /accounts/{account_id}/devices/registrations/{registration_id}": getRegistration,
	...
	"POST /accounts/{account_id}/dex/devices/dex_tests": deviceDexTestCreateDeviceDexTest,
	"DELETE /accounts/{account_id}/dex/devices/dex_tests/{dex_test_id}":
		deviceDexTestDeleteDeviceDexTest,
	"GET /accounts/{account_id}/dex/devices/dex_tests/{dex_test_id}": deviceDexTestGetDeviceDexTest,
	...
	"POST /accounts/{account_id}/dlp/datasets/{dataset_id}/versions/{version}/entries/{entry_id}":
		dlpDatasetsUploadDatasetColumn,
	"GET /accounts/{account_id}/dlp/document_fingerprints": dlpDocumentFingerprintsReadAll,
	"POST /accounts/{account_id}/dlp/document_fingerprints": dlpDocumentFingerprintsCreate,
	...
	"PUT /accounts/{account_id}/dlp/entries/custom/{entry_id}": dlpEntriesUpdateCustomEntry,
	"POST /accounts/{account_id}/dlp/entries/integration": dlpEntriesCreateIntegrationEntry,
	"DELETE /accounts/{account_id}/dlp/entries/integration/{entry_id}":
		dlpEntriesDeleteIntegrationEntry,
	"PUT /accounts/{account_id}/dlp/entries/integration/{entry_id}": dlpEntriesUpdateIntegrationEntry,
	"POST /accounts/{account_id}/dlp/entries/predefined": dlpEntriesCreatePredefinedEntry,
	"DELETE /accounts/{account_id}/dlp/entries/predefined/{entry_id}":
		dlpEntriesDeletePredefinedEntry,
	"PUT /accounts/{account_id}/dlp/entries/predefined/{entry_id}": dlpEntriesUpdatePredefinedEntry,
	...
	"GET /accounts/{account_id}/dlp/profiles/custom": dlpProfilesListAllCustomProfiles,
	...
	"POST /accounts/{account_id}/dlp/profiles/predefined": dlpProfilesCreatePredefinedProfile,
	...
	"PATCH /accounts/{account_id}/dns_firewall/{dns_firewall_id}/reverse_dns":
		dnsFirewallUpdateDnsFirewallClusterReverseDns,
	"GET /accounts/{account_id}/dns_records/usage": dnsRecordsForAnAccountGetUsage,
	...
	"GET /accounts/{account_id}/email-security/investigate/{postfix_id}/trace":
		emailSecurityGetMessageTrace,
	"GET /accounts/{account_id}/email-security/phishguard/reports": emailSecurityGetPhishguardReports,
	...
	"PUT /accounts/{account_id}/event_notifications/r2/{bucket_name}/configuration/queues/{queue_id}":
		r2PutEventNotificationConfig,
	"GET /accounts/{account_id}/event_subscriptions/subscriptions": subscriptionsList,
	"POST /accounts/{account_id}/event_subscriptions/subscriptions": subscriptionsCreate,
	...
	"GET /accounts/{account_id}/gateway/app_types":
		zeroTrustGatewayApplicationAndApplicationTypeMappingsListApplicationAndApplicationTypeMappings,
	"GET /accounts/{account_id}/gateway/apps/review_status": zeroTrustApplicationsReviewStatusList,
	"PUT /accounts/{account_id}/gateway/apps/review_status": zeroTrustApplicationsReviewStatusUpdate,
	...
	"DELETE /accounts/{account_id}/iam/user_groups/{user_group_id}": accountUserGroupDelete,
	"GET /accounts/{account_id}/iam/user_groups/{user_group_id}": accountUserGroupDetails,
	"PUT /accounts/{account_id}/iam/user_groups/{user_group_id}": accountUserGroupUpdate,
	"GET /accounts/{account_id}/iam/user_groups/{user_group_id}/members": accountUserGroupMemberList,
	...
	"POST /accounts/{account_id}/infrastructure/targets/batch_delete": infraTargetsDeleteBatchPost,
	...
	"GET /accounts/{account_id}/magic/advanced_tcp_protection/configs/prefixes":
		listPrefixesForAccount,
	"POST /accounts/{account_id}/magic/advanced_tcp_protection/configs/prefixes": createPrefix,
	...
	"PATCH /accounts/{account_id}/magic/apps/{account_app_id}": magicAccountAppsPatchApp,
	...
	"GET /accounts/{account_id}/magic/cloud/catalog-syncs/prebuilt-policies":
		catalogSyncsPrebuiltPoliciesList,
	"DELETE /accounts/{account_id}/magic/cloud/catalog-syncs/{sync_id}": catalogSyncsDelete,
	"GET /accounts/{account_id}/magic/cloud/catalog-syncs/{sync_id}": catalogSyncsRead,
	"PATCH /accounts/{account_id}/magic/cloud/catalog-syncs/{sync_id}": catalogSyncsPatch,
	"PUT /accounts/{account_id}/magic/cloud/catalog-syncs/{sync_id}": catalogSyncsUpdate,
	"POST /accounts/{account_id}/magic/cloud/catalog-syncs/{sync_id}/refresh": catalogSyncsRefresh,
	...
	"PUT /accounts/{account_id}/magic/cloud/onramps/magic_wan_address_space":
		onrampsMwanAddrSpaceUpdate,
	"DELETE /accounts/{account_id}/magic/cloud/onramps/{onramp_id}": onrampsDelete,
	...
	"POST /accounts/{account_id}/magic/cloud/onramps/{onramp_id}/apply": onrampsApply,
	"POST /accounts/{account_id}/magic/cloud/onramps/{onramp_id}/export": onrampsExport,
	"POST /accounts/{account_id}/magic/cloud/onramps/{onramp_id}/plan": onrampsPlan,
	...
	"POST /accounts/{account_id}/magic/cloud/providers/discover": providersDiscoverAll,
	"DELETE /accounts/{account_id}/magic/cloud/providers/{provider_id}": providersDelete,
	"GET /accounts/{account_id}/magic/cloud/providers/{provider_id}": providersRead,
	"PATCH /accounts/{account_id}/magic/cloud/providers/{provider_id}": providersPatch,
	"PUT /accounts/{account_id}/magic/cloud/providers/{provider_id}": providersUpdate,
	"POST /accounts/{account_id}/magic/cloud/providers/{provider_id}/discover": providersDiscover,
	...
	"GET /accounts/{account_id}/magic/cloud/resources/export": resourcesCatalogExport,
	"POST /accounts/{account_id}/magic/cloud/resources/policy-preview": resourcesCatalogPolicyPreview,
	"GET /accounts/{account_id}/magic/cloud/resources/{resource_id}": resourcesCatalogRead,
	...
	"DELETE /accounts/{account_id}/magic/connectors/{connector_id}": mconnConnectorDelete,
	...
	"DELETE /accounts/{account_id}/magic/sites/{site_id}/netflow_config":
		magicSiteNetflowConfigDeleteNetflowConfig,
	"GET /accounts/{account_id}/magic/sites/{site_id}/netflow_config": magicSiteNetflowConfigDetails,
	...
	"DELETE /accounts/{account_id}/pay-per-crawl/crawler/stripe":
		payPerCrawlCrawlerDeleteStripeConfig,
	"GET /accounts/{account_id}/pay-per-crawl/crawler/stripe": payPerCrawlCrawlerGetStripeConfig,
	"POST /accounts/{account_id}/pay-per-crawl/crawler/stripe": payPerCrawlCrawlerCreateStripeConfig,
	"DELETE /accounts/{account_id}/pay-per-crawl/publisher/stripe":
		payPerCrawlPublisherDeleteStripeConfig,
	"GET /accounts/{account_id}/pay-per-crawl/publisher/stripe": payPerCrawlPublisherGetStripeConfig,
	...
	"PUT /accounts/{account_id}/pcaps/{pcap_id}/stop": magicPcapCollectionStopFullPcap,
	"GET /accounts/{account_id}/pipelines": getV4AccountsByAccountIdPipelinesDeprecated,
	"POST /accounts/{account_id}/pipelines": postV4AccountsByAccountIdPipelinesDeprecated,
	"GET /accounts/{account_id}/pipelines/v1/pipelines": getV4AccountsByAccountIdPipelinesV1Pipelines,
	...
	"GET /accounts/{account_id}/pipelines/v1/pipelines/{pipeline_id}":
		getV4AccountsByAccountIdPipelinesV1PipelinesByPipelineId,
	"GET /accounts/{account_id}/pipelines/v1/sinks": getV4AccountsByAccountIdPipelinesV1Sinks,
	"POST /accounts/{account_id}/pipelines/v1/sinks": postV4AccountsByAccountIdPipelinesV1Sinks,
	"DELETE /accounts/{account_id}/pipelines/v1/sinks/{sink_id}":
		deleteV4AccountsByAccountIdPipelinesV1SinksBySinkId,
	"GET /accounts/{account_id}/pipelines/v1/sinks/{sink_id}":
		getV4AccountsByAccountIdPipelinesV1SinksBySinkId,
	"GET /accounts/{account_id}/pipelines/v1/streams": getV4AccountsByAccountIdPipelinesV1Streams,
	"POST /accounts/{account_id}/pipelines/v1/streams": postV4AccountsByAccountIdPipelinesV1Streams,
	...
	"GET /accounts/{account_id}/queues/{queue_id}/consumers/{consumer_id}": queuesGetConsumer,
	...
	"POST /accounts/{account_id}/queues/{queue_id}/messages/batch": queuesPushMessages,
	...
	"POST /accounts/{account_id}/r2-catalog/{bucket_name}/credential": storeCredentials,
	"POST /accounts/{account_id}/r2-catalog/{bucket_name}/disable": disableCatalog,
	"POST /accounts/{account_id}/r2-catalog/{bucket_name}/enable": enableCatalog,
	"GET /accounts/{account_id}/r2-catalog/{bucket_name}/maintenance-configs": getMaintenanceConfig,
	"POST /accounts/{account_id}/r2-catalog/{bucket_name}/maintenance-configs":
		updateMaintenanceConfig,
	"GET /accounts/{account_id}/r2-catalog/{bucket_name}/namespaces": listNamespaces,
	"GET /accounts/{account_id}/r2-catalog/{bucket_name}/namespaces/{namespace}/tables": listTables,
	...
	"GET /accounts/{account_id}/realtime/kit/{app_id}/analytics/daywise": getOrgAnalytics,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/analytics/livestreams/overall":
		getLivestreamAnalyticsComplete,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/livestreams": fetchAllLivestreams,
	...
	"GET /accounts/{account_id}/realtime/kit/{app_id}/meetings/{meeting_id}": getMeeting,
	"PATCH /accounts/{account_id}/realtime/kit/{app_id}/meetings/{meeting_id}": updateMeeting,
	"PUT /accounts/{account_id}/realtime/kit/{app_id}/meetings/{meeting_id}": replaceMeeting,
	...
	"DELETE /accounts/{account_id}/realtime/kit/{app_id}/presets/{preset_id}": deletePresetsPresetId,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/presets/{preset_id}": getPresetsPresetId,
	"PATCH /accounts/{account_id}/realtime/kit/{app_id}/presets/{preset_id}": patchPresetsPresetId,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/recordings": getAllRecordings,
	"POST /accounts/{account_id}/realtime/kit/{app_id}/recordings": startRecording,
	...
	"POST /accounts/{account_id}/realtime/kit/{app_id}/recordings/track":
		startTrackRecordingForAMeeting,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/recordings/{recording_id}": getOneRecording,
	...
	"GET /accounts/{account_id}/realtime/kit/{app_id}/sessions/peer-report/{peer_id}":
		getParticipantDataFromPeerId,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/sessions/{session_id}": getSessionDetails,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/sessions/{session_id}/chat": getSessionChat,
	...
	"DELETE /accounts/{account_id}/realtime/kit/{app_id}/webhooks/{webhook_id}": deleteWebhook,
	"GET /accounts/{account_id}/realtime/kit/{app_id}/webhooks/{webhook_id}": getWebhook,
	"PATCH /accounts/{account_id}/realtime/kit/{app_id}/webhooks/{webhook_id}": editWebhook,
	"PUT /accounts/{account_id}/realtime/kit/{app_id}/webhooks/{webhook_id}": replaceWebhook,
	...
	"GET /accounts/{account_id}/rules/lists/{list_id}/items/{item_id}": listsGetAListItem,
	...
	"DELETE /accounts/{account_id}/secrets_store/stores/{store_id}": secretsStoreDeleteById,
	"DELETE /accounts/{account_id}/secrets_store/stores/{store_id}/secrets": secretsStoreDeleteBulk,
	"GET /accounts/{account_id}/secrets_store/stores/{store_id}/secrets": secretsStoreSecretsList,
	"POST /accounts/{account_id}/secrets_store/stores/{store_id}/secrets": secretsStoreSecretCreate,
	...
	"PUT /accounts/{account_id}/shares/{share_id}/recipients": shareRecipientsUpdate,
	...
	"GET /accounts/{account_id}/slurper/jobs/{job_id}/progress": slurperGetJobProgress,
	"PUT /accounts/{account_id}/slurper/jobs/{job_id}/resume": slurperResumeJob,
	"PUT /accounts/{account_id}/slurper/source/connectivity-precheck": slurperCheckSourceConnectivity,
	"PUT /accounts/{account_id}/slurper/target/connectivity-precheck": slurperCheckTargetConnectivity,
	"GET /accounts/{account_id}/sso_connectors": getAllSsoConnectors,
	"POST /accounts/{account_id}/sso_connectors": initNewSsoConnector,
	"DELETE /accounts/{account_id}/sso_connectors/{sso_connector_id}": deleteSsoConnector,
	"GET /accounts/{account_id}/sso_connectors/{sso_connector_id}": getSsoConnector,
	"PATCH /accounts/{account_id}/sso_connectors/{sso_connector_id}": updateSsoConnectorState,
	...
	"GET /accounts/{account_id}/vectorize/v2/indexes/{index_name}/list": vectorizeListVectors,
	...
	"GET /accounts/{account_id}/waiting_rooms": waitingRoomListWaitingRoomsAccount,
	...
	"GET /accounts/{account_id}/workers/durable_objects/namespaces/{id}/objects":
		durableObjectsNamespaceListObjects,
	"GET /accounts/{account_id}/workers/observability/destinations": destinationList,
	"POST /accounts/{account_id}/workers/observability/destinations": destinationCreate,
	"DELETE /accounts/{account_id}/workers/observability/destinations/{slug}": destinationsDelete,
	"PATCH /accounts/{account_id}/workers/observability/destinations/{slug}": destinationUpdate,
	"POST /accounts/{account_id}/workers/observability/telemetry/keys": telemetryKeysList,
	"POST /accounts/{account_id}/workers/observability/telemetry/query": telemetryQuery,
	"POST /accounts/{account_id}/workers/observability/telemetry/values": telemetryValuesList,
	"GET /accounts/{account_id}/workers/placement/regions": workerPlacementListRegions,
	"GET /accounts/{account_id}/workers/scripts": workerScriptListWorkers,
	"GET /accounts/{account_id}/workers/scripts-search": workerScriptSearchWorkers,
	...
	"PATCH /accounts/{account_id}/workers/scripts/{script_name}/script-settings":
		workerScriptSettingsPatchSettings,
	"GET /accounts/{account_id}/workers/scripts/{script_name}/secrets": workerListScriptSecrets,
	"PUT /accounts/{account_id}/workers/scripts/{script_name}/secrets": workerPutScriptSecret,
	...
	"PATCH /accounts/{account_id}/workers/services/{service_name}/environments/{environment_name}/settings":
		workerScriptEnvironmentPatchSettings,
	"DELETE /accounts/{account_id}/workers/subdomain": workerSubdomainDeleteSubdomain,
	...
	"GET /accounts/{account_id}/workers/workers/{worker_id}/versions": listWorkerVersions,
	"POST /accounts/{account_id}/workers/workers/{worker_id}/versions": createWorkerVersion,
	"DELETE /accounts/{account_id}/workers/workers/{worker_id}/versions/{version_id}":
		deleteWorkerVersion,
	"GET /accounts/{account_id}/workers/workers/{worker_id}/versions/{version_id}": getWorkerVersion,
	...
	"PATCH /accounts/{account_id}/zerotrust/connectivity_settings":
		zeroTrustAccountsPatchConnectivitySettings,
	"GET /accounts/{account_id}/zerotrust/routes/hostname": zeroTrustNetworksRouteHostnameList,
	"POST /accounts/{account_id}/zerotrust/routes/hostname": zeroTrustNetworksRouteHostnameCreate,
	...
	"POST /organizations/{organization_id}/members:batchCreate": membersBatchCreate,
	...
	"GET /radar/ai/bots/timeseries_groups/{dimension}": radarGetAiBotsTimeseriesGroup,
	...
	"GET /radar/ai/inference/timeseries_groups/{dimension}": radarGetAiInferenceTimeseriesGroup,
	...
	"GET /radar/as112/timeseries_groups/response_codes":
		radarGetDnsAs112TimeseriesGroupByResponseCodes,
	"GET /radar/as112/timeseries_groups/{dimension}": radarGetDnsAs112TimeseriesGroup,
	...
	"GET /radar/attacks/layer3/summary/industry": radarGetAttacksLayer3SummaryByIndustry,
	...
	"GET /radar/attacks/layer3/summary/vertical": radarGetAttacksLayer3SummaryByVertical,
	...
	"GET /radar/attacks/layer3/timeseries_groups/vertical":
		radarGetAttacksLayer3TimeseriesGroupByVertical,
	"GET /radar/attacks/layer3/timeseries_groups/{dimension}": radarGetAttacksLayer3TimeseriesGroup,
	...
	"GET /radar/attacks/layer7/summary/industry": radarGetAttacksLayer7SummaryByIndustry,
	...
	"GET /radar/attacks/layer7/summary/mitigation_product":
		radarGetAttacksLayer7SummaryByMitigationProduct,
	"GET /radar/attacks/layer7/summary/vertical": radarGetAttacksLayer7SummaryByVertical,
	...
	"GET /radar/attacks/layer7/timeseries_groups/vertical":
		radarGetAttacksLayer7TimeseriesGroupByVertical,
	"GET /radar/attacks/layer7/timeseries_groups/{dimension}": radarGetAttacksLayer7TimeseriesGroup,
	...
	"GET /radar/bots/crawlers/timeseries_groups/{dimension}": radarGetCrawlersTimeseriesGroup,
	...
	"GET /radar/dns/summary/matching_answer": radarGetDnsSummaryByMatchingAnswerStatus,
	...
	"GET /radar/dns/timeseries_groups/cache_hit": radarGetDnsTimeseriesGroupByCacheHitStatus,
	"GET /radar/dns/timeseries_groups/dnssec": radarGetDnsTimeseriesGroupByDnssec,
	"GET /radar/dns/timeseries_groups/dnssec_aware": radarGetDnsTimeseriesGroupByDnssecAwareness,
	"GET /radar/dns/timeseries_groups/dnssec_e2e": radarGetDnsTimeseriesGroupByDnssecE2eVersion,
	"GET /radar/dns/timeseries_groups/ip_version": radarGetDnsTimeseriesGroupByIpVersion,
	"GET /radar/dns/timeseries_groups/matching_answer":
		radarGetDnsTimeseriesGroupByMatchingAnswerStatus,
	"GET /radar/dns/timeseries_groups/protocol": radarGetDnsTimeseriesGroupByProtocol,
	"GET /radar/dns/timeseries_groups/query_type": radarGetDnsTimeseriesGroupByQueryType,
	"GET /radar/dns/timeseries_groups/response_code": radarGetDnsTimeseriesGroupByResponseCode,
	"GET /radar/dns/timeseries_groups/response_ttl": radarGetDnsTimeseriesGroupByResponseTtl,
	...
	"GET /radar/email/routing/timeseries_groups/{dimension}": radarGetEmailRoutingTimeseriesGroup,
	...
	"GET /radar/email/security/timeseries_groups/tls_version":
		radarGetEmailSecurityTimeseriesGroupByTlsVersion,
	"GET /radar/email/security/timeseries_groups/{dimension}": radarGetEmailSecurityTimeseriesGroup,
	...
	"GET /radar/leaked_credential_checks/summary/compromised":
		radarGetLeakedCredentialChecksSummaryByCompromised,
	"GET /radar/leaked_credential_checks/summary/{dimension}": radarGetLeakedCredentialChecksSummary,
	...
	"GET /radar/netflows/timeseries_groups/{dimension}": radarGetNetflowsTimeseriesGroup,
	...
	"GET /radar/origins/timeseries_groups/{dimension}": radarGetOriginsTimeseriesGroup,
	...
	"GET /radar/ranking/internet_services/categories": radarGetRankingInternetServicesCategories,
	...
	"PUT /zones/{zone_id}/access/service_tokens/{service_token_id}":
		zoneLevelAccessServiceTokensUpdateAServiceToken,
	"GET /zones/{zone_id}/acm/custom_trust_store": customOriginTrustStoreListDetails,
	...
	"POST /zones/{zone_id}/bot_management/feedback": botManagementZoneFeedbackCreate,
	...
	"PUT /zones/{zone_id}/content-upload-scan/settings": wafContentScanningUpdateSettings,
	...
	"GET /zones/{zone_id}/dns_records/scan/review": dnsRecordsForAZoneReviewDnsScan,
	"POST /zones/{zone_id}/dns_records/scan/review": dnsRecordsForAZoneApplyDnsScanResults,
	"POST /zones/{zone_id}/dns_records/scan/trigger": dnsRecordsForAZoneTriggerDnsScan,
	...
	"DELETE /zones/{zone_id}/hostnames/settings/{setting_id}/{hostname}":
		perHostnameTlsSettingsDelete,
	"GET /zones/{zone_id}/hostnames/settings/{setting_id}/{hostname}": perHostnameTlsSettingsGet,
	...
	"GET /zones/{zone_id}/rulesets/{ruleset_id}/versions/{ruleset_version}/by_tag/{rule_tag}":
		listZoneRulesetVersionRulesByTag,
	"GET /zones/{zone_id}/schema_validation/schemas": schemaValidationListSchemasPaginated,
	"POST /zones/{zone_id}/schema_validation/schemas": schemaValidationCreateSchema,
	"GET /zones/{zone_id}/schema_validation/schemas/hosts": schemaValidationListSchemaHosts,
	"DELETE /zones/{zone_id}/schema_validation/schemas/{schema_id}": schemaValidationDeleteSchema,
	"GET /zones/{zone_id}/schema_validation/schemas/{schema_id}": schemaValidationGetSchema,
	"PATCH /zones/{zone_id}/schema_validation/schemas/{schema_id}": schemaValidationEditSchema,
	"GET /zones/{zone_id}/schema_validation/schemas/{schema_id}/operations":
		schemaValidationExtractOperationsFromSchema,
	"GET /zones/{zone_id}/schema_validation/settings": schemaValidationGetSettings,
	"PATCH /zones/{zone_id}/schema_validation/settings": schemaValidationEditSettings,
	"PUT /zones/{zone_id}/schema_validation/settings": schemaValidationUpdateSettings,
	...
	"GET /zones/{zone_id}/settings/ssl_automatic_mode": sslDetectorAutomaticModeGetEnrollment,
	"PATCH /zones/{zone_id}/settings/ssl_automatic_mode": sslDetectorAutomaticModePatchEnrollment,
	...
	"GET /zones/{zone_id}/smart_shield/cache_reserve_clear": smartShieldSettingsGetCacheReserveClear,
	...
	"POST /zones/{zone_id}/smart_shield/healthchecks": smartShieldCreateHealthCheck,
	"DELETE /zones/{zone_id}/smart_shield/healthchecks/{healthcheck_id}":
		smartShieldDeleteHealthCheck,
	"GET /zones/{zone_id}/smart_shield/healthchecks/{healthcheck_id}": smartShieldHealthCheckDetails,
	"PATCH /zones/{zone_id}/smart_shield/healthchecks/{healthcheck_id}": smartShieldPatchHealthCheck,
	"PUT /zones/{zone_id}/smart_shield/healthchecks/{healthcheck_id}": smartShieldUpdateHealthCheck,
	...
	"PATCH /zones/{zone_id}/ssl/certificate_packs/{certificate_pack_id}":
		certificatePacksRestartValidationForAdvancedCertificateManagerCertificatePack,
	"GET /zones/{zone_id}/ssl/recommendation": sslTlsModeRecommendationSslTlsRecommendation,
	...
	"DELETE /zones/{zone_id}/token_validation/config/{config_id}": tokenValidationConfigDelete,
	"GET /zones/{zone_id}/token_validation/config/{config_id}": tokenValidationConfigGet,
	"PATCH /zones/{zone_id}/token_validation/config/{config_id}": tokenValidationConfigEdit,
	...
	"PATCH /zones/{zone_id}/token_validation/rules/bulk": tokenValidationRulesBulkEdit,
	"POST /zones/{zone_id}/token_validation/rules/bulk": tokenValidationRulesBulkCreate,
	"POST /zones/{zone_id}/token_validation/rules/preview": tokenValidationRulesPreview,
	"DELETE /zones/{zone_id}/token_validation/rules/{rule_id}": tokenValidationRulesDelete,
	"GET /zones/{zone_id}/token_validation/rules/{rule_id}": tokenValidationRulesGet,
	"PATCH /zones/{zone_id}/token_validation/rules/{rule_id}": tokenValidationRulesEdit,
