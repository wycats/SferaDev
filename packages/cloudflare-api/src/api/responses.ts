...
export type ApiShieldBulkCreateRulesSuccess = Schemas.ApiShieldApiResponseCollection & {
	result: Schemas.ApiShieldRule[];
};

export type ApiShieldBulkEditRulesSuccess = Schemas.ApiShieldApiResponseCollection & {
	result: Schemas.ApiShieldRule[];
};

export type ApiShieldConfigGetSuccess = Schemas.ApiShieldConfigurationSingleResponse;

export type ApiShieldConfigUpdateSuccess = Schemas.ApiShieldConfigurationSingleResponse;

export type ApiShieldCreateConfigSuccess = Schemas.ApiShieldApiResponseCommon & {
...
export type ApiShieldDeleteConfigSuccess = Schemas.ApiShieldApiResponseCommon & {
	result: {
...
export type ApiShieldListConfigsSuccess = Schemas.ApiShieldApiResponseCollection & {
	result: Schemas.ApiShieldTokenConfiguration[];
};

export type ApiShieldListRulesSuccess = Schemas.ApiShieldApiResponseCollection & {
	result: Schemas.ApiShieldRule[];
};
...
export type ApiShieldPreviewRulesSuccess = Schemas.ApiShieldApiResponseCollection & {
	result: {
		/**
...
export type ApiShieldUpdateConfigCredentialsSuccess = Schemas.ApiShieldApiResponseCommon &
	Schemas.ApiShieldCredentials;
...
export type RealtimekitGetActiveSessionNotFound = Schemas.RealtimekitGenericErrorResponse;
...
export type RealtimekitGetMeeting = Schemas.RealtimekitGenericSuccessResponse & {
	data?: Schemas.RealtimekitMeeting;
} & Record<string, any>;
...
export type RealtimekitParticipantNotFound = Schemas.RealtimekitGenericErrorResponse;
