...
export type ApiShieldBulkCreateRules = Schemas.ApiShieldCreateSingleRuleRequest[];
...
export type PayPerCrawlZonesCanBeEnabledPayload = Schemas.PayPerCrawlZonesCanBeEnabledPayload;
