...
export type OrganizationsApiOrganizationListFiltersContainingOrganization = string;

export type OrganizationsApiOrganizationListFiltersContainingUser = string;

export type OrganizationsApiOrganizationListFiltersId = Schemas.OrganizationsApiOrganizationID[];
...
export type RealtimekitRecordingStatus = ("INVOKED" | "RECORDING" | "UPLOADING" | "UPLOADED")[];
...
export type ResourceSharingResourceTypes = Schemas.ResourceSharingResourceType[];
