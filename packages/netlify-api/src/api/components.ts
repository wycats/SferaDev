...
export type ProvisionSiteTLSCertificateError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 422>;
	payload: {
		/**
		 * @format int64
		 */
...
export type CreateSiteBuildError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 400 | 404 | 422>;
	payload: {
		/**
		 * @format int64
		 */
 ...
 */
export const enableSite = (variables: EnableSiteVariables, signal?: AbortSignal) =>
 ...
 */
export const disableSite = (variables: DisableSiteVariables, signal?: AbortSignal) =>
	fetch<undefined, DisableSiteError, undefined, {}, DisableSiteQueryParams, DisableSitePathParams>({
		url: "/sites/{siteId}/disable",
		method: "put",
		...variables,
		signal,
	});
...
export type UpdateDeployValidationsError = Fetcher.ErrorWrapper<undefined>;

export type UpdateDeployValidationsResponse = {
	/**
...
export type UpdateDeployValidationsRequestBody = {
	secrets_scan?: Record<string, any>;
};

export type UpdateDeployValidationsVariables = {
	body?: UpdateDeployValidationsRequestBody;
...
export const updateDeployValidations = (
	...
	fetch<
		...
		UpdateDeployValidationsRequestBody,
		{},
		{},
...
export type ListAgentRunnersError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type ListAgentRunnersResponse = {
	id?: string;
	site_id?: string;
...
export type ListAgentRunnersVariables = {
	queryParams: ListAgentRunnersQueryParams;
} & FetcherExtraProps;

export const listAgentRunners = (variables: ListAgentRunnersVariables, signal?: AbortSignal) =>
	fetch<
		ListAgentRunnersResponse,
		ListAgentRunnersError,
		undefined,
		{},
		ListAgentRunnersQueryParams,
		{}
	>({ url: "/agent_runners", method: "get", ...variables, signal });
...
export type CreateAgentRunnerError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 404 | 422>;
	payload: {
		/**
		 * @format int64
		 */
...
export type CreateAgentRunnerVariables = {
	queryParams: CreateAgentRunnerQueryParams;
} & FetcherExtraProps;

export const createAgentRunner = (variables: CreateAgentRunnerVariables, signal?: AbortSignal) =>
	fetch<
		CreateAgentRunnerResponse,
		CreateAgentRunnerError,
		undefined,
		{},
		CreateAgentRunnerQueryParams,
		{}
	>({ url: "/agent_runners", method: "post", ...variables, signal });
...
export type CreateAgentRunnerUploadUrlError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 400 | 422>;
	payload: {
		/**
		 * @format int64
		 */
...
export type CreateAgentRunnerUploadUrlVariables = {
	queryParams: CreateAgentRunnerUploadUrlQueryParams;
} & FetcherExtraProps;

export const createAgentRunnerUploadUrl = (
	variables: CreateAgentRunnerUploadUrlVariables,
	signal?: AbortSignal,
) =>
	fetch<
		undefined,
		CreateAgentRunnerUploadUrlError,
		undefined,
		{},
		CreateAgentRunnerUploadUrlQueryParams,
		{}
	>({ url: "/agent_runners/upload_url", method: "post", ...variables, signal });

export type GetAgentRunnerPathParams = {
	agentRunnerId: string;
};

export type GetAgentRunnerError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type GetAgentRunnerResponse = {
	id?: string;
	site_id?: string;
	parent_agent_runner_id?: string;
	state?: string;
...
export type GetAgentRunnerVariables = {
	pathParams: GetAgentRunnerPathParams;
} & FetcherExtraProps;

export const getAgentRunner = (variables: GetAgentRunnerVariables, signal?: AbortSignal) =>
	fetch<GetAgentRunnerResponse, GetAgentRunnerError, undefined, {}, {}, GetAgentRunnerPathParams>({
		url: "/agent_runners/{agentRunnerId}",
		method: "get",
		...variables,
		signal,
	});
...
export type UpdateAgentRunnerError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type UpdateAgentRunnerResponse = {
	id?: string;
	site_id?: string;
	parent_agent_runner_id?: string;
	state?: string;
...
export type UpdateAgentRunnerVariables = {
	pathParams: UpdateAgentRunnerPathParams;
} & FetcherExtraProps;

export const updateAgentRunner = (variables: UpdateAgentRunnerVariables, signal?: AbortSignal) =>
	fetch<
		UpdateAgentRunnerResponse,
		UpdateAgentRunnerError,
		undefined,
		{},
		{},
...
export type DeleteAgentRunnerError = Fetcher.ErrorWrapper<{
...
export type DeleteAgentRunnerVariables = {
	pathParams: DeleteAgentRunnerPathParams;
} & FetcherExtraProps;

export const deleteAgentRunner = (variables: DeleteAgentRunnerVariables, signal?: AbortSignal) =>
	fetch<undefined, DeleteAgentRunnerError, undefined, {}, {}, DeleteAgentRunnerPathParams>({
		url: "/agent_runners/{agentRunnerId}",
		method: "delete",
		...variables,
		signal,
...
export type ArchiveAgentRunnerError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 202 | 404 | 422>;
	payload: {
		/**
		 * @format int64
		 */
...
export type ArchiveAgentRunnerVariables = {
	pathParams: ArchiveAgentRunnerPathParams;
} & FetcherExtraProps;

export const archiveAgentRunner = (variables: ArchiveAgentRunnerVariables, signal?: AbortSignal) =>
	fetch<undefined, ArchiveAgentRunnerError, undefined, {}, {}, ArchiveAgentRunnerPathParams>({
		url: "/agent_runners/{agentRunnerId}/archive",
		method: "post",
		...variables,
		signal,
	});
...
export type AgentRunnerPullRequestError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 400 | 409 | 422>;
	payload: {
		/**
		 * @format int64
		 */
...
export type AgentRunnerPullRequestVariables = {
	pathParams: AgentRunnerPullRequestPathParams;
} & FetcherExtraProps;

export const agentRunnerPullRequest = (
	variables: AgentRunnerPullRequestVariables,
	signal?: AbortSignal,
) =>
	fetch<
		undefined,
		AgentRunnerPullRequestError,
		undefined,
		{},
		{},
		AgentRunnerPullRequestPathParams
	>({
		url: "/agent_runners/{agentRunnerId}/pull_request",
		method: "post",
		...variables,
		signal,
	});
...
export type AgentRunnerCommitToBranchError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 400 | 409 | 422>;
	payload: {
		/**
		 * @format int64
...
export type AgentRunnerCommitToBranchVariables = {
	pathParams: AgentRunnerCommitToBranchPathParams;
	queryParams: AgentRunnerCommitToBranchQueryParams;
} & FetcherExtraProps;

export const agentRunnerCommitToBranch = (
	variables: AgentRunnerCommitToBranchVariables,
	signal?: AbortSignal,
) =>
	fetch<
		undefined,
		AgentRunnerCommitToBranchError,
		undefined,
		{},
		AgentRunnerCommitToBranchQueryParams,
		AgentRunnerCommitToBranchPathParams
	>({
		url: "/agent_runners/{agentRunnerId}/commit",
		method: "post",
		...variables,
		signal,
	});
...
export type ListAgentRunnerSessionsError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type ListAgentRunnerSessionsVariables = {
	pathParams: ListAgentRunnerSessionsPathParams;
	queryParams?: ListAgentRunnerSessionsQueryParams;
} & FetcherExtraProps;

export const listAgentRunnerSessions = (
	variables: ListAgentRunnerSessionsVariables,
	signal?: AbortSignal,
) =>
	fetch<
		ListAgentRunnerSessionsResponse,
		ListAgentRunnerSessionsError,
		undefined,
		{},
		ListAgentRunnerSessionsQueryParams,
		ListAgentRunnerSessionsPathParams
	>({
		url: "/agent_runners/{agentRunnerId}/sessions",
		method: "get",
		...variables,
		signal,
	});
...
export type CreateAgentRunnerSessionError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 404 | 422>;
	payload: {
		/**
		 * @format int64
...
export type CreateAgentRunnerSessionVariables = {
	pathParams: CreateAgentRunnerSessionPathParams;
	queryParams?: CreateAgentRunnerSessionQueryParams;
} & FetcherExtraProps;

export const createAgentRunnerSession = (
	variables: CreateAgentRunnerSessionVariables,
	signal?: AbortSignal,
) =>
	fetch<
		CreateAgentRunnerSessionResponse,
		CreateAgentRunnerSessionError,
		undefined,
		{},
...
export type GetAgentRunnerSessionError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type GetAgentRunnerSessionVariables = {
	pathParams: GetAgentRunnerSessionPathParams;
} & FetcherExtraProps;

export const getAgentRunnerSession = (
	variables: GetAgentRunnerSessionVariables,
	signal?: AbortSignal,
) =>
	fetch<
		GetAgentRunnerSessionResponse,
		GetAgentRunnerSessionError,
		undefined,
		{},
		{},
		GetAgentRunnerSessionPathParams
	>({
		url: "/agent_runners/{agentRunnerId}/sessions/{agentRunnerSessionId}",
		method: "get",
		...variables,
		signal,
	});
...
export type UpdateAgentRunnerSessionError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type UpdateAgentRunnerSessionVariables = {
	pathParams: UpdateAgentRunnerSessionPathParams;
	queryParams?: UpdateAgentRunnerSessionQueryParams;
} & FetcherExtraProps;

export const updateAgentRunnerSession = (
	variables: UpdateAgentRunnerSessionVariables,
	signal?: AbortSignal,
) =>
	fetch<
		UpdateAgentRunnerSessionResponse,
		UpdateAgentRunnerSessionError,
		undefined,
		{},
...
export type DeleteAgentRunnerSessionError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 202>;
	payload: {
		/**
		 * @format int64
...
export type DeleteAgentRunnerSessionVariables = {
	pathParams: DeleteAgentRunnerSessionPathParams;
} & FetcherExtraProps;

export const deleteAgentRunnerSession = (
	variables: DeleteAgentRunnerSessionVariables,
	signal?: AbortSignal,
) =>
	fetch<
		undefined,
		DeleteAgentRunnerSessionError,
		undefined,
		{},
		{},
...
export type UpdateDevServerStateError = Fetcher.ErrorWrapper<undefined>;
...
export type UpdateDevServerStateRequestBody = {
	state: "starting" | "live" | "error" | "done";
	task_id?: string;
	error?: string;
};

export type UpdateDevServerStateVariables = {
	body: UpdateDevServerStateRequestBody;
	pathParams: UpdateDevServerStatePathParams;
} & FetcherExtraProps;

export const updateDevServerState = (
	variables: UpdateDevServerStateVariables,
	signal?: AbortSignal,
) =>
	fetch<
		UpdateDevServerStateResponse,
		UpdateDevServerStateError,
		UpdateDevServerStateRequestBody,
		{},
		{},
		UpdateDevServerStatePathParams
	>({
		url: "/sites/{siteId}/dev_servers/{devServerId}/state",
		method: "post",
		...variables,
		signal,
	});
...
export type GetAIGatewayProvidersError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export const getAIGatewayProviders = (
	variables: GetAIGatewayProvidersVariables,
	signal?: AbortSignal,
) =>
	fetch<GetAIGatewayProvidersResponse, GetAIGatewayProvidersError, undefined, {}, {}, {}>({
...
export type GetAIGatewayTokenError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 404>;
	payload: {
		/**
		 * @format int64
		 */
...
export type GetAIGatewayTokenVariables = {
 ...
 */
export const getAIGatewayToken = (variables: GetAIGatewayTokenVariables, signal?: AbortSignal) =>
	fetch<
		GetAIGatewayTokenResponse,
		GetAIGatewayTokenError,
		undefined,
		{},
		{},
		GetAIGatewayTokenPathParams
	>({
		url: "/sites/{siteId}/ai-gateway/token",
		method: "get",
		...variables,
		signal,
	});
...
export const operationsByTag = {
	...
	aiGateway: { getAIGatewayProviders, getAIGatewayToken },
};
