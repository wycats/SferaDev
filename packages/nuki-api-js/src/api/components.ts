...
export type GetSmartlocksAuthsPaginatedResourceError = Fetcher.ErrorWrapper<undefined>;

export type GetSmartlocksAuthsPaginatedResourceVariables = {
	queryParams?: GetSmartlocksAuthsPaginatedResourceQueryParams;
} & FetcherExtraProps;

export const getSmartlocksAuthsPaginatedResource = (
	variables: GetSmartlocksAuthsPaginatedResourceVariables,
	signal?: AbortSignal,
) =>
	fetch<
		Schemas.PaginatedResponse,
		GetSmartlocksAuthsPaginatedResourceError,
		undefined,
		{},
		GetSmartlocksAuthsPaginatedResourceQueryParams,
		{}
	>({ url: "/smartlock/auth/paged", method: "get", ...variables, signal });
