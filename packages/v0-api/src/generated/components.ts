...
export async function chatsDelete({
	...
	const data = await request<
		...
		Record<string, string>,
		ChatsDeletePathParams
	>({ method: "DELETE", url: `/chats/${pathParams["chatId"]}`, ...requestConfig });
	return data;
}
...
export async function chatsGetById({
	...
	const data = await request<
		...
		Record<string, string>,
		ChatsGetByIdPathParams
	>({ method: "GET", url: `/chats/${pathParams["chatId"]}`, ...requestConfig });
	return data;
}
...
export async function projectsGetByChatId({
	...
	const data = await request<
		...
		Record<string, string>,
		ProjectsGetByChatIdPathParams
	>({ method: "GET", url: `/chats/${pathParams["chatId"]}/project`, ...requestConfig });
	return data;
}
...
export async function deploymentsGetById({
	...
	const data = await request<
		...
		Record<string, string>,
		DeploymentsGetByIdPathParams
	>({ method: "GET", url: `/deployments/${pathParams["deploymentId"]}`, ...requestConfig });
	return data;
}
...
export async function deploymentsDelete({
	...
	const data = await request<
		...
		Record<string, string>,
		DeploymentsDeletePathParams
	>({ method: "DELETE", url: `/deployments/${pathParams["deploymentId"]}`, ...requestConfig });
	return data;
}
...
export async function deploymentsFindErrors({
	...
	const data = await request<
		...
		Record<string, string>,
		DeploymentsFindErrorsPathParams
	>({ method: "GET", url: `/deployments/${pathParams["deploymentId"]}/errors`, ...requestConfig });
	return data;
}
...
export async function hooksGetById({
	...
	const data = await request<
		...
		Record<string, string>,
		HooksGetByIdPathParams
	>({ method: "GET", url: `/hooks/${pathParams["hookId"]}`, ...requestConfig });
	return data;
}
...
export async function hooksDelete({
	...
	const data = await request<
		...
		Record<string, string>,
		HooksDeletePathParams
	>({ method: "DELETE", url: `/hooks/${pathParams["hookId"]}`, ...requestConfig });
	return data;
}
...
export async function projectsGetById({
	...
	const data = await request<
		...
		Record<string, string>,
		ProjectsGetByIdPathParams
	>({ method: "GET", url: `/projects/${pathParams["projectId"]}`, ...requestConfig });
	return data;
}
...
export async function projectsDelete({
	...
	const data = await request<
		...
		Record<string, string>,
		ProjectsDeletePathParams
	>({ method: "DELETE", url: `/projects/${pathParams["projectId"]}`, ...requestConfig });
	return data;
}
