...
Migration and deprecation details are consolidated in [RFC 007](./007-migration-deprecation.md), including the settings migration script, namespace transitions, and user communication plan.
