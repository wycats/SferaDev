...
describe("ToolHistoryManager", () => {
  ...
  describe("addToolCall", () => {
    ...
    it("should categorize read operations correctly", () => {
      ...
      const firstCall = result.recentCalls[0];
      if (firstCall === undefined) {
        throw new Error("Expected firstCall to be defined");
      }
      expect(firstCall.callText).toContain("read_file");
    });
    ...
    it("should categorize write operations correctly", () => {
      ...
      expect(firstCall.callText).toContain("create_file");
    });
  });
  ...
  describe("edge cases", () => {
    ...
    it("should handle tools with missing args", () => {
      ...
      expect(firstCall.callText).toContain("<!-- prior-tool: get_time");
    });
